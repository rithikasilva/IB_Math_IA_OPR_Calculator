...
match_data = pd.read_csv("csv_data/ontario_combined_matches.csv", header=None)
# Create a pandas DataFrame with team involved in event
team_numbers = pd.read_csv("csv_data/ontario_combined_teams.csv", header=None)
# Create a pandas DataFrame with data from 2019 provincial championship matches
match_data_for_error_reference = pd.read_csv("csv_data/2019_ontario_championship_combined_matches.csv", header=None)
